...
///
/// This is intended for use between tests. **Do not call in production code.**
...
/// Alias for [`admin_only_reset_hooks`] for use within this crate's own tests.
#[cfg(test)]
...
mod tests {
    ...
    fn hook_receives_correct_status() {
        ...
        assert_eq!(
            *seen_code.lock().unwrap(),
            Some(crate::Code::ResourceExhausted)
        );
    }
